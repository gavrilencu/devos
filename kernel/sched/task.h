...
/* Page fault user (Milestone 54): creste stiva la cerere (demand paging).
 * 1 = pagina mapata, instructiunea se reia; 0 = fault real (proces oprit). */
int task_user_fault(uint64_t addr);
/* 1 daca `addr` cade in/langa stiva user (pentru mesajul de stack overflow). */
